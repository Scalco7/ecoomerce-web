...
export default function HistorySection() {
  const monkeysHistory = {
    imageSrc: "/historys-img/banana-comp-teste.jpg",
    history:
  ...
  const luidaoHistory = {
    title: "Luidão",
    titleColor: "#FF5F00",
    imageSrc: "/historys-img/luidao-teste.jpg",
    history:
      "Para mostrar cada um dos Banana Monkey's, nada melhor do que começar pelo membro que define a essência do grupo: Luidão. Ele é o mais autêntico e imprevisível, alguém de quem você nunca sabe o que esperar. Conhecido como o último romântico, ele está sempre apaixonado, e se a garota for ruiva, é paixão à primeira vista. Ele é um verdadeiro Banana Monkey. Além de ser um eterno apaixonado, ele adora jogar um fute e dar altos rolês aleatórios. O Luidão tem a habilidade de transformar qualquer situação em uma aventura divertida, sempre fazendo as coisas do seu jeito muito louco, e só dele. Mais do que isso, ele é um cara leal, alguém em quem você pode confiar em qualquer momento. Ele é, sem dúvida, a essência, um companheiro de todas as horas, que torna tudo mais da hora e ajuda com o que precisar.",
  };
