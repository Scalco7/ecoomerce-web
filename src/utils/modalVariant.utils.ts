...
export function openModalVariant(variant: VariantType, setVariantSectionIsOpen: Dispatch<SetStateAction<boolean>>, setResolveModalVariant: Dispatch<SetStateAction<ModalVariantPromise | null>>, setCurrentVariant: Dispatch<SetStateAction<VariantType | undefined>>,): Promise<string | undefined> {
